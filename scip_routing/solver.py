...
def solve_colgen(graph, instance, verbosity=0, distance_fn=None, pricing_strategy="py"):
...
class VRPTWSolver:
    def __init__(self, graph, instance, verbosity=0, distance_fn=None, pricing_strategy="py"):
    ...
    def solve(self):
        ...
        self.rmp.setIntParam("lp/threads", 4)
        ...
        if self.verbosity > 0:
            ...
            print(round(self.rmp.getObjVal(), 2))
